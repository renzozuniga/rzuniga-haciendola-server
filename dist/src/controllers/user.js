...
exports.changePassword = exports.forgotPassword = exports.loginUser = exports.newUser = void 0;
...
const changePassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const passwordOld = yield bcrypt_1.default.compare(user.password, newPassword);
    if (passwordOld) {
        return res.status(400).json({
    ...
    const hashedPassword = yield bcrypt_1.default.hash(confirmPassword, 10);
    try {
        user.password = hashedPassword;
        yield user.save();
        res.json({
